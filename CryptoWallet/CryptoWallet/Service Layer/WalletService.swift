...
//guard let urlPolkadot = URL(string: "https://data.messari.io/api/v1/assets/btc/metrics") else { return }
//guard let urlPolkadot = URL(string: "https://data.messari.io/api/v1/assets/eth/metrics") else { return }
//guard let urlPolkadot = URL(string: "https://data.messari.io/api/v1/assets/tron/metrics") else { return }
